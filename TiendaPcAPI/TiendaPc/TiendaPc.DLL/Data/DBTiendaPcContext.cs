...
public partial class DBTiendaPcContext : DbContext
{
    public DBTiendaPcContext(DbContextOptions<DBTiendaPcContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<PedidosFormasPago> PedidosFormasPagos { get; set; }
